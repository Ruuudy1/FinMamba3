...
def main():
    ...
    # Post-scan (non-gauge) escalation overlays: the output-side gate decays to identity at the same rate as
    # the input-affine gate, the visual signature of the overdetermined null (gauge absorption + recon dominance).
    ...
    # reg_H is pinned at the uniform-router maximum (log 4 = 1.386) throughout; a fixed [1.0, 1.5] window
    # keeps the axis on clean two-decimal ticks (the auto-range collapses to a garbled 1.378-1.386 zoom).
